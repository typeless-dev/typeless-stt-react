...
const useRecordAudio = ({ onNewResult, websocketUrl, language, hotwords, hotwordsWeight, onStop, manualPunctuation, voiceCommands, domain, }) => {
    ...
    const startRecording = (callKey) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const websocketInstance = new WebsocketManager_1.WebsocketManager(onNewResult, websocketUrl, language, callKey, hotwords, onStop, manualPunctuation, hotwordsWeight, voiceCommands, domain);
